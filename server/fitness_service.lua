...
function fitnessSystem.Server.Service.ProcessTrainingRequest(src, identifier, spotType)
    ...
    local currentStats = fitnessSystem.Server.Repository.GetStat(identifier, statName)
    local currentLevel = currentStats and currentStats.level or 1
    local currentXp = currentStats and currentStats.xp or 0
